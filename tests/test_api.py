...
def test_query(wait_for_api):
    ...
    assert item == json.loads('{"data":[{"MemberEmail":"d*****y@gmail.com","MemberFirstName":"David","MemberLastName":"Conroy","MemberNationalAssociationId":"084001677","license_data":[{"agency":"NY","number":"1234586","type":"Broker"},{"agency":"NY","number":"a12356","type":"Appraisal"},{"agency":"MA","number":"78910","type":"Salesperson"},{"agency":"NH","number":"654321","type":"Salesperson"}],"uli":"6020799b37479173c35f8140"},{"possible_matches:":1}],"message":"ULI May Exist!","status":true}')
